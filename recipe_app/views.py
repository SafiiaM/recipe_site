...
def recipe_add(request):
    ...
    if not request.user.is_authenticated:
        return HttpResponseForbidden("Только зарегистрированные пользователи могут добавлять рецепты.")
...
def recipe_edit(request, recipe_id):
    ...
    if request.user != recipe.user:
        return HttpResponseForbidden("У вас нет прав на редактирование этого рецепта.")
